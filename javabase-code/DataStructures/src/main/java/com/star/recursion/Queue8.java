...
/**
 * @author 枯灯少年
 * @Date 2021/09/08 12:55
 * @Description: 递归回溯解决 8皇后
 */
public class Queue8 {
    //定义一个max表示共有多少个皇后
    int max = 8;
    ...
    private boolean judge(int n){
        ...
        for (int i = 0; i < n; i++) {
            ...
            //2、Math.abs(n-i) == Math.abs(array[n]-array[i]) 第n个皇后是否和第i个皇后是否在同一斜线
            // n = 1 放在第 2列 n=1 array[1] = 1
            //3、判断是否在同一行，没必要，因为n每次都在递增
