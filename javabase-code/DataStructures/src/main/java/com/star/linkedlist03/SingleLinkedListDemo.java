...
//        singleLinkedList.add(hero4);
        ...
        //测试一下，求链表中有效节点的个数
        System.out.println("有效的节点个数:"+getLength(singleLinkedList.getHead()) + "个");
...
//        singleLinkedList.list();
    ...
    //题一：获取到单链表的节点的个数(如果是带头节点的链表，需求不统计头节点)
    /**
     * @param head 链表的头节点
     * @return 返回的就是有效节点的个数
     */
...
class SingleLinkedList{
    ...
    //2.说明我们在此比较时，是temp.next.no 和 需要删除的节点的no比较
