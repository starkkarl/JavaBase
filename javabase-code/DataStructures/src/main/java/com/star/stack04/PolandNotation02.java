...
public class PolandNotation02 {
    public static void main(String[] args) {
        ...
        //3.获得到的中缀表达式对应的List => 后缀表达式对应的List
        // 即 ArrayList [1,+,(,(,2,+,3),*,4,),-,5] =》 ArrayList [1,2,3,+,4,*,+,5,-]
        String expression = "1+((2+3)*4)-5";
        List<String> strings = toInfixExpressionList(expression);
        System.out.println("中缀表达式对应的List--"+strings); // [1, +, (, (, 2, +, 3, ), x, 4, ), -, 5]
...
//        String suffixExpression  = "30 4 + 10 x 6 -";
    ...
    // 即 ArrayList [1,+,(,(,2,+,3),*,4,),-,5] =》 ArrayList [1,2,3,+,4,*,+,5,-]
    // 方法：获得到的中缀表达式对应的List => 后缀表达式对应的List
...
//        Stack<String> s2 = new Stack<String>();//储存中间结果的栈s2
        ...
        for(String item:ls){
            ...
            if(item.matches("\\d+")){
                ...
                // 如果是右括号")"，则依次弹出s1栈项目的运算符，并压入s2，直到遇到左括号为止，此时将这一对括号丢弃
