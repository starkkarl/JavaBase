...
public class Calculator {
    public static void main(String[] args) {
        //根据前面的思路：完成表达式的运算
        String expression = "70*3+20*6-4/2";//存在bug，如何处理多位数的问题？78+2*6-4
        //创建两个栈，数栈和符号栈
        ...
        while (true) {
            ...
            if (operStack.isOper(ch)) {// 如果是运算符
                ...
                //numStack.push(ch - 48);//? "1+3"  '1' => 1 有问题：处理多位数
                //分析思路
                // 1.当处理多位数时，不能法案现是一个数就立即入栈，因为他可能是多位数
